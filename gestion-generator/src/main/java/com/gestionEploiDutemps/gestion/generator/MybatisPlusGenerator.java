package com.gestionEploiDutemps.gestion.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "com.gestionEploiDutemps.gestion";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/gestion-model"),
        mapper("/gestion-dao"),
        mapperxml("/gestion-web"),
